...
public class LibarterBeApplication {
	...
	CommandLineRunner run(RoleRepository roleRepository, UserRepository userRepository, PasswordEncoder passwordEncoder){
		return args -> {
			...
			ApplicationUser admin = new ApplicationUser(1, "{bcrypt}" + passwordEncoder.encode("password"), "monticelli.bryan@gmail.com", "admin", "+359897952626", roles);
